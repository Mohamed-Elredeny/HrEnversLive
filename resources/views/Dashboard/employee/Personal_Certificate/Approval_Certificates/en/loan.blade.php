    ...
    @foreach($employee as $emp)
        <div class="col-12" style="; padding: 20px">
            ...
            month.</span>
                ...
                <br><br>
                The bank and above named employee fully understands that <span style="font-size:10px;display: inline;font-weight: bold">{{$emp->company_id}}</span> does not, in any way, hold
                itself responsible for any debits incurred by him and that the granting of credit or loan is the sole discretion
                of your Bank.
                <br><br></h5>
            Yours truly,
            <br>
            <b >For<span style="font-size:10px;display: inline;font-weight: bold"> {{$emp->company_id}}</span></b>
            <br>
            <div class="row">
                <div class="col-6">
                        <?php

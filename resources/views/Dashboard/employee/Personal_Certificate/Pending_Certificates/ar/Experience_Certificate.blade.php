    ...
    <div class="content_certificate">
        <div class="header_certificate">
            <div class="text-right" dir="rtl">
                <h5>
            <span style="color:#a39e9e">
                                التاريخ:
                                {{$certificate->date_submit}}
            </span>
                    <br>
                    <span style="color:#a39e9e">  Ref: HRA-MG</span>
                </h5>
            </div>
        </div>
        <br>
        <div class="body_certificate">
            <div class="text-right " dir="rtl">
                ...
                <h3 class="text-center font-weight-bold"><b
                        style="font-weight: bold;display: inline; text-decoration: underline; text-underline-offset: 5px;"><u>افادة
                            عمل</u></b></h3>
                <br><br>
                <h4>تفيد شركه
                    {{$employee->company_id}}
                    ...
                    <br> <br></h4>
                <h4>
                    أعطيت له هذه الأفادة بطلب من المعني دون أدنى مسؤولية على <span

...
@section('certificate_content')
    <div class="col-12 ar_text" style=" padding: 20px">
        ...
        <div class="text-right " dir="rtl">
            ...
            <span style="font-weight: bold;display: inline;"> mena{{$employee->arabic_designation}} </span>
            منذ تاريخ
            <span style="font-weight: bold;display: inline;">12/8 {{$employee->joiningDate}}</span>
            يزال على رأس
            عمله.
               <br> <br></h4>
            <h4>
